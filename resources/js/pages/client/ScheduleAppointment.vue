...
<template>
    ...
    <UApp>
        <UContainer class="flex h-full flex-col items-center justify-center p-4 sm:p-6">
            ...
            <h1 class="mt-6 text-center text-5xl font-black">{{ page.props.name }}</h1>
            ...
            <UCard class="mt-16 sm:p-4">
                ...
                <div v-if="!submitted">
                    ...
                    <div class="mt-6 mb-12 px-4 text-center sm:mt-0">
                        <h2 class="text-4xl font-bold">Schedule an appointment!</h2>
                        <p class="mt-4">We'll get back to you as soon as possible.</p>
                    </div>
